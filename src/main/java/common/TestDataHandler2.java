...
public class TestDataHandler2 {
	...
	public static TestDataHandler2 loadTestData(String sheet, String... where) throws Exception {
	...
	public static TestDataHandler2 loadTestData(Recordset record) throws Exception {
		TestDataHandler2 testDataHandler = new TestDataHandler2();
